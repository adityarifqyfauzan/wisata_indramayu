...
<div class="col-lg-12">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">Tabel Wisata Baru</div>
        <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover table-responsive" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= substr($data['alamat'], 0, 30) ?></td>
                                <td><span class="bg-success text-white p-1">pengajuan baru</span></td>
                                <td class="text-center"><a href="/admin/wisata/<?= $data['id'] ?>" class="btn btn-info">Lihat Detail</a></td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
