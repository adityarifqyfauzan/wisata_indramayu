...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?= ($title == "Data Wisata" || $title == "Pengajuan Wisata Baru" || $title == "Kategori Wisata") ? "active" : "" ?>">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu Data Wisata:</h6>
                        <a class="collapse-item" href="/admin/wisata">Lihat Data</a>
                        <a class="collapse-item" href="/admin/wisata/baru">Pengajuan Baru</a>
                        <a class="collapse-item" href="/admin/kategori_wisata">Kategori Wisata</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item btn-logout" href="/admin/logout">
